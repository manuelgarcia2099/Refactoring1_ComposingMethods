 ...
 */
public class Ej10_Problema {
	
	private static final Logger log = Logger.getLogger(Ej10_Problema.class);
	...
	public Ej10_Problema (String nombre, String modelo, double precio, int cantidad) {
		this.nombre=nombre;
		this.modelo=modelo;
		this.precio=precio;
	...
	//#R
	private double generarDescuento(double precio, int cantidad) {
		...
		if(precio > 1000) precio -= 2;
		if(cantidad > 100) precio -= 1;
		if(marcaMAC && modeloMACBOOKPRO14) precio -= 4;
