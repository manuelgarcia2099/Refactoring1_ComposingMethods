 ...
 */
public class Ej5_SolNatural {
	
	private static final Logger log = Logger.getLogger(Ej5_SolNatural.class);

	private String nombre;
	private Vector productos = new Vector();
	
	public Ej5_SolNatural (String nombre) {
		this.nombre=nombre;
	}
	...
	private double getEvaluacionDeDescuento(double deuda) {
		return ((deuda>500))? (deuda*10)/100 :0;
	}
