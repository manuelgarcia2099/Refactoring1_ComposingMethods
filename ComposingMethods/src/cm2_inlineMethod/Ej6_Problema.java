 ...
 */
public class Ej6_Problema {
	
	private static final Logger log = Logger.getLogger(Ej6_Problema.class);

	private String nombre;
	private Vector productos = new Vector();
	
	public Ej6_Problema (String nombre) {
		this.nombre=nombre;
	}
	...
	private double getEvaluarDescuentoPorProducto(double precio) {
		...
		return (descuento>1000)?(descuento*10)/100:0;
	}
